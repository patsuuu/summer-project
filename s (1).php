<a href="admin2_page.php?>"><input type="submit" value="Back"></a>
<!DOCTYPE html>
<html lang="en">
<head>
<style>
...
<div class="form-container">
    <center>
        <h2>DATA</h2>
        <form method="get" action="admin2_page.php">
        ...
        if (isset($_GET['search_title'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row['title'] . "</td><td>" . $row['details'] . "</td><td>" . $row['authors'] . "</td><td><a href='v.php?title=" . urlencode($row['title']) . "'>View</a></td></tr>";
                }
                echo "</table>";
            } else {
                // No results found
